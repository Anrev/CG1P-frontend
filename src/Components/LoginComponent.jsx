...
import { SESSION_USER_BUSINESS, SESSION_USER_ID, SESSION_USER_NAME, SESSION_USER_ROLE, SESSION_TOKEN, SESSION_BUSINESS_INDUSTRY_NAME} from '../Constants.js'
    ...
    loginClicked() {
        AuthenticationService.executeJwtAuthenticationService(this.state.email, this.state.password)
            ...
            .then(response => {
                ...
                sessionStorage.setItem(SESSION_BUSINESS_INDUSTRY_NAME, response.data.business.industry.name)
